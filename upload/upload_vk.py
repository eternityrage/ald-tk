"""
Upload videos to VK (VKontakte) - AldaTok Lens
"""
import os
import vk_api
...
def upload_to_vk(video_path, description="", title=""):
    ...
    try:
        ...
        message = description if description else "AldaTok Lens - Alexandra Daddario Moments!\n\n#alexandraddario #hollywood #trueblood #percyjackson #baywatch #fashion #celebrity"
        ...
        video = upload.video(
            ...
            name=title or 'AldaTok Lens Video',
