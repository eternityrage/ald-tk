"""
Facebook Reels Upload - AldaTok Lens
...
def upload_to_facebook(video_path, description, title="AldaTok Lens"):
    print("\n" + "=" * 60)
    print("FACEBOOK UPLOAD STARTING - ALDATOK LENS")
    print("=" * 60)
...
def upload_to_facebook_story(video_path):
    print("\n" + "=" * 60)
    print("FACEBOOK STORY UPLOAD STARTING - ALDATOK LENS")
    print("=" * 60)
